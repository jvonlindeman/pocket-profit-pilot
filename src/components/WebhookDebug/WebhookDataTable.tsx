            ...
            <tr key={index} className={isIncomeArray(item) ? "bg-green-50" : isCollaboratorArray(item) ? "bg-blue-50" : ""}>
              ...
              <td className="p-2 border-b font-medium">
                {isIncomeArray(item) 
                  ...
                  : isCollaboratorArray(item)
                    ? `Array de Colaboradores (${Array.isArray(item) ? item.length : 0} elementos)`
              ...
              <td className="p-2 border-b">
                {isIncomeArray(item) ? (
                  ...
                  <div>
                    <p className="font-medium mb-1">Ejemplos de colaboradores:</p>
                    <ul className="list-disc pl-5">
                      {item.slice(0, 3).map((collab, idx) => (
                        <li key={idx} className="text-sm">
                          {collab.vendor_name}: {collab.total}

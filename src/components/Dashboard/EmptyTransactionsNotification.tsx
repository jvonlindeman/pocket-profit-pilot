...
interface EmptyTransactionsNotificationProps {
  isEmpty: boolean;
}

const EmptyTransactionsNotification: React.FC<EmptyTransactionsNotificationProps> = ({ isEmpty }) => {
...
export default EmptyTransactionsNotification;

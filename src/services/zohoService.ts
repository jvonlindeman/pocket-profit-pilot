...
export const repairCache = zohoRepository.repairCache.bind(zohoRepository); // Kept for compatibility
export const checkAndRefreshCache = zohoRepository.checkAndRefreshCache.bind(zohoRepository); // Kept for compatibility

...
export const useFinanceData = () => {
  ...
  // Función para procesar y separar ingresos - No dependencies on other callbacks
  ...
  // Función para procesar datos de colaboradores - No dependencies on other callbacks
  ...
  // Fetch monthly balance for the selected month - Has no dependency on other callbacks
  ...
  // Update the starting balance - Has no dependency on other callbacks
  ...
  // Update the stripe override value - Using processIncomeTypes but defining it AFTER processIncomeTypes
